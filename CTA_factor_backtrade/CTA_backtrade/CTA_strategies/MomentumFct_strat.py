...
from CTA_factor_backtrade.CTA_indicators.Momentum_ind import Mmt_ind
...
class Mmt_Strategy(bt.Strategy):
    params = (('shift_pos_days', 30),('skn_window_prd',30), ('asset_ratio', 0.2),
    ...
    def Indicator_Create(self):
        ...
        # 如果数据是实时生成，那么调用相关指标进行计算
            ...
            for i, vt in self.index_mapping_vt.items():        
                self.Mmt_ind[vt] = Mmt_ind(window_period = self.params.skn_window_prd,
