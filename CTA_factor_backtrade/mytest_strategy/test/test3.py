...
class TestStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.skn_ind = Ctaskn_ind( datafeed = self.datas[0],window_period = self.params.skn_window_prd)   
        self.Mmt_ind = Mmt_ind( datafeed = self.datas[0], window_period = 18)
    def start(self):
...
if __name__ == '__main__':  
    ...
    datapath = r'D:/backtrader/backtrader-master/CTA_factor_backtrade/mytest_strategy/testdata/CFE_IC_dom.csv'
